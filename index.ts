...
// tslint:disable-next-line:max-func-body-length
    ...
    let maps: Maps = new Maps({
        ...
        layers: [
            {
                shapeData: new MapAjax('//ej2.syncfusion.com/demos/src/dashboard-layout/worldmap.json'),
                shapePropertyPath: 'continent',
                shapeDataPath: 'continent',
                dataSource: new MapAjax('//ej2.syncfusion.com/demos/src/dashboard-layout/datasource.json'),
                shapeSettings: {
                ...
                markerSettings: [
                    {
                        ...
                        shape: 'Image',
                        imageUrl: 'https://ej2.syncfusion.com/demos///ej2.syncfusion.com/demos/src/maps/images/ballon.png',
                        height: 20,
                        width: 20,
                        offset: {
                            y: -10,
